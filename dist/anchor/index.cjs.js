...
const solwin_PROGRAM_ID = new web3_js.PublicKey(solwinIDL.address);
// This is a helper function to get the solwin Anchor program.
function getsolwinProgram(provider) {
    return new anchor.Program(solwinIDL, provider);
}
...
function getsolwinProgramId(cluster) {
    switch(cluster){
        ...
        case 'testnet':
            ...
            return new web3_js.PublicKey('ETMR2uxTjbFDYrhaQcPRJZyAYNDdSDcuCDg4doTvqPXv');
        case 'mainnet-beta':
        default:
...
exports.getsolwinProgram = getsolwinProgram;
exports.getsolwinProgramId = getsolwinProgramId;
exports.solwinIDL = solwinIDL;
exports.solwin_PROGRAM_ID = solwin_PROGRAM_ID;
